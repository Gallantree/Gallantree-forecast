...
export interface IHeadcount {
  ...
  // represent unfilled future hires backing a per-FY headcount target. They
  // flow through cost projections like real staff but are managed as a group
  // (regenerated wholesale whenever targets change) and aren't editable in
  // the staff table.
  isGrowth?: boolean;
  createdAt: Date;
  updatedAt: Date;

...
export interface StaffRow {
  ...
  // can't be edited individually — they're managed wholesale by re-saving
  // the per-FY targets.
  isGrowth?: boolean;
}
...
export function StaffingTab({
  ...
  // Forecast year numbers (e.g. [2027, 2028, 2029, 2030, 2031]). Drives the
  // Plan-growth modal's row count.
  fys: number[];
        ...
        <div className="flex gap-6">
          <div>
            ...
            <div className="text-base font-semibold text-zinc-900">
              ...
              {growthCount > 0 ? (
                <span
                  className="ml-1 text-[11px] font-medium text-amber-700"
                ...
                return (
                  ...
                  >
                    <Td>
                      {r.isGrowth ? (
                        <span
                          className="rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-amber-800"
                          title="Generated by the Plan growth modal"
                        >
                          Growth
                        </span>
                      ) : isContinuation ? (

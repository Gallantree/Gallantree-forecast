    ...
    <>
      ...
      {open && (
        <dialog
          ...
          className="w-[520px] max-w-[92vw] rounded-lg border border-zinc-200 p-0 shadow-xl backdrop:bg-zinc-900/40"
        >
          ...
          <div className="flex flex-col gap-4 px-6 py-5 text-sm">
            ...
            <label className="flex flex-col gap-1">
              ...
              <select
                value={status}
                onChange={(e) =>
                  setStatus(e.target.value as "active" | "pending" | "archived")
                }
                className="rounded-md border border-zinc-300 px-3 py-2"
              >

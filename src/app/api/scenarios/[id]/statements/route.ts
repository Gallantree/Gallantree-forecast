...
export async function GET(_req: NextRequest, { params }: Ctx) {
  ...
  return NextResponse.json({
    ...
    bs: {
      ...
      prepaidIssuanceCosts: ser(s.bs.prepaidIssuanceCosts),
      cash: ser(s.bs.cash),
      totalAssets: ser(s.bs.totalAssets),
      deferredRevenue: ser(s.bs.deferredRevenue),
    ...
    cf: {
      ...
      issuanceAmortisation: ser(s.cf.issuanceAmortisation),
      changeInAr: ser(s.cf.changeInAr),
      changeInAp: ser(s.cf.changeInAp),
      changeInDeferredRevenue: ser(s.cf.changeInDeferredRevenue),
      capexOutflow: ser(s.cf.capexOutflow),
      issuanceCostOutflow: ser(s.cf.issuanceCostOutflow),
